...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConjurDatabaseSpec) DeepCopyInto(out *ConjurDatabaseSpec) {
	*out = *in
	if in.Count != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConjurDatabaseSpec.
func (in *ConjurDatabaseSpec) DeepCopy() *ConjurDatabaseSpec {
	if in == nil {
		return nil
	}
	out := new(ConjurDatabaseSpec)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConjurServerSpec) DeepCopyInto(out *ConjurServerSpec) {
	*out = *in
	if in.Count != nil {
		in, out := &in.Count, &out.Count
		*out = new(int32)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConjurServerSpec.
func (in *ConjurServerSpec) DeepCopy() *ConjurServerSpec {
	if in == nil {
		return nil
	}
	out := new(ConjurServerSpec)
	in.DeepCopyInto(out)
	return out
}
